...
ggplot(sourcelevel.ints, aes(x = type, y = est)) +
  geom_point(size = 4) +
  geom_errorbar(width = .15, aes(ymin = lower, ymax = upper)) + 
  theme_bw() +
  geom_hline(aes(yintercept=0), linetype = "dashed") +
...
ggplot(freq.ints, aes(x = type, y = est)) +
  geom_point(size = 4) +
  geom_errorbar(width = .15, aes(ymin = lower, ymax = upper)) + 
  theme_bw() +
  geom_hline(aes(yintercept=0), linetype = "dashed") +
...
ggplot(duration.ints, aes(x = type, y = est)) +
  geom_point(size = 4) +
  geom_errorbar(width = .15, aes(ymin = lower, ymax = upper)) + 
  theme_bw() +
  geom_hline(aes(yintercept=0), linetype = "dashed") +
...
ggplot(total.time.ints, aes(x = type, y = est)) +
  geom_point(size = 4) +
  geom_errorbar(width = .15, aes(ymin = lower, ymax = upper)) + 
  theme_bw() +
  geom_hline(aes(yintercept=0), linetype = "dashed") +
  ylab("Total time slope estimate") +
  theme(text = element_text(size = 20)) 
